...
public class UserController {
    ...
    User newUser(@RequestBody User newUser){
        ...
        List<User> getAllUsers(){
            System.out.println("Debug: UserController getAllUsers method");
        return  userRepository.findAll();
    }

     @GetMapping("/user/{id}")
    User getUserById(@PathVariable Long id) {
        System.out.println("Debug: UserController getUserById method");
    ...
    User updateUser(@RequestBody User newUser, @PathVariable Long id) {
        System.out.println("Debug: UserController updateUser method");
        return userRepository.findById(id)
                .map(user -> {
    ...
    String deleteUser(@PathVariable Long id){
        System.out.println("Debug: UserController deleteUser method");
